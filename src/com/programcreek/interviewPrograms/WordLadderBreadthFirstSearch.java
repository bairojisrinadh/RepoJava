...
public class WordLadderBreadthFirstSearch {

	public static void main(String[] args) {
		String beginWord = "hit";
		String endWord = "cog";
		List<String> list = Arrays.asList("hot","dot","dog","lot","log");
		Set<String> dictionary = new LinkedHashSet<>(list);
		//dictionary.forEach(i -> System.out.println(i));
		int ladderLength = ladderLength(beginWord, endWord, dictionary);
